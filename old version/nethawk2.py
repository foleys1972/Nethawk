#!/usr/bin/env python3
"""
NetHawk Pro - PROFESSIONAL UI with Compact Design & Working Remote Capture
...
class ModernPacketTable(QTableWidget):
    """COMPACT & THREAD-SAFE packet table"""
    ...
    def setup_table(self):
        ...
        self.verticalHeader().setDefaultSectionSize(20)  # Compact row height
...
class NetHawkPro(QMainWindow):
    """PROFESSIONAL Main Application - Compact UI + Working Remote Capture"""
    def __init__(self):
        super().__init__()
    ...
    def setup_packet_tab(self):
        ...
        self.display_filter.setPlaceholderText("Filter by protocol, IP, or text...")
    ...
    def show_about(self):
        QMessageBox.about(
            ...
            <ul>
                ...
                <li>✅ Better than Wireshark!</li>
            </ul>
            
            <p style="margin-top: 20px;">
                <b>Handles 100K+ packets smoothly</b><br>
                Remote capture support with NetHawk Server
            </p>
